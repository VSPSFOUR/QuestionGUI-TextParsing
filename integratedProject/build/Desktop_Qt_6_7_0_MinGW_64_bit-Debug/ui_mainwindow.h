...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget1->setGeometry(QRect(80, 50, 281, 61));
        ...
        layoutWidget2->setGeometry(QRect(40, 330, 501, 33));
        ...
        gradeButton->setGeometry(QRect(40, 370, 83, 29));
        indexInput = new QLineEdit(centralwidget);
        indexInput->setObjectName("indexInput");
        indexInput->setGeometry(QRect(250, 370, 113, 24));
        changeIndexButton = new QPushButton(centralwidget);
        changeIndexButton->setObjectName("changeIndexButton");
        changeIndexButton->setGeometry(QRect(370, 370, 111, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        gradeButton->setText(QCoreApplication::translate("MainWindow", "Grade Quiz", nullptr));
        changeIndexButton->setText(QCoreApplication::translate("MainWindow", "Index Change", nullptr));
    } // retranslateUi
